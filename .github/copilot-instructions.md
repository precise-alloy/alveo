...
- For `alveo` generated assets, sourcemaps, prerendered HTML, and cache-busting hashes, make output deterministic across Windows, WSL, and Ubuntu inside the build tooling. Do not depend on project-specific `.gitattributes`, `core.autocrlf`, or local checkout line endings.
